...
PAPER = env.PAPER  # True for paper trading, False for live trading
trade_api_url = 'https://paper-api.alpaca.markets/v2'
trade_api_wss = 'https://paper-api.alpaca.markets/v2'
data_api_url = 'https://paper-api.alpaca.markets/v2'
stream_data_wss = 'https://paper-api.alpaca.markets/v2'
